...
/* const eventsArr = [
  {
    ...
    events: [
      {
        title: "Event 1 lorem ipsun dolor sit genfa tersd dsad",
        time: "10:00 AM",
      },
      {
        title: "Event 2",
...
addEventFrom.addEventListener("input", (e) => {
  ...
  // dont let user enter more that 5 chars
...
eventsContainer.addEventListener("click", (e) => {
  if (e.target.classList.contains("event")) {
    ...
    // get the title of event then search in array by title
    eventsArr.forEach((event) => {
      if (
        event.day === activeDay &&
        event.month === month + 1 &&
        ...
        //if no event remainig on that day remove complete day
